  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center w-full px-4">
      ...
      >
        ...
        {/* Disclaimer */}
        <div className="rounded-2xl bg-ab-separator/60 px-3 py-3 md:px-4 md:py-5">
          <p className="text-center text-xs leading-4 text-ab-text-3 md:text-sm md:leading-5">
            {disclaimerText}
          </p>
        </div>
      </div>
      ...
      {/* Action buttons */}
      <div className="mt-4 md:mt-6 flex w-full max-w-[448px] gap-3 md:gap-4">
        <button
          className={cn(
            'flex flex-1 items-center justify-center rounded-2xl border border-ab-border px-4 py-[11px] md:px-6 md:py-[13px]',
        ...
        <button
          className={cn(
            'flex flex-1 items-center justify-center gap-2 rounded-2xl px-4 py-[11px] md:px-6 md:py-[13px]',
