...
describe('useStablecoinBalances', () => {
  const mockStellarAddress = 'GA7QYNF7SOWQ3GLR2BGMZEHXAVIRZA4KVWLTJJFC7MGXUA74P7UJVSGZ'
  ...
  describe('supportedBalanceFor', () => {
    it('should return balance for requested symbol', async () => {
      ...
      expect(result.current.supportedBalanceFor('cUSD')).toBe('25.00')
    })
  })
  ...
  describe('refresh function', () => {
    ...
    it('should clear balances when address becomes null', async () => {
      ...
      const { result, rerender } = renderHook(
        ({ address, chainId }) => useStablecoinBalances({ address, chainId }),
        {
          initialProps: { address: mockEvmAddress, chainId: 'eip155:42220' },
        },
      )
