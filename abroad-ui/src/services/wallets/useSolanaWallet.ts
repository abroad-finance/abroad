 ...
 */
function getSolanaProvider(): null | {
...
export const useSolanaWallet = (walletAuth?: IWalletAuthentication): SolanaWalletState => {
      ...
      const walletError
        = error instanceof Object && 'code' in error
          ...
          : createWalletError(
              ...
              { chainId: SOLANA_CHAIN_ID, details: error },
            )
  ...
  return { error: state.error, isConnecting: state.isConnecting, wallet }
}
