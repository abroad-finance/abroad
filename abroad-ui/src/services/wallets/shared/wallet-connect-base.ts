...
export const WC_METADATA: SignClientMetadata = {
  ...
  icons: [
    'https://cdn.prod.website-files.com/66d73974e0b6f2e9c06130a7/67c084e407b55642ef7d6cd4_Favicon.png',
  ],
}
 ...
 */
export function getWCSession(chainId: string): WalletConnectSession | null {
  try {
