...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { DecodeQrController } from './controllers/DecodeQrController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { AcceptTransactionController } from './controllers/AcceptTransactionController';
...
const models: TsoaRoute.Models = {
    "TransactionStatusResponse": {
        ...
        "properties": {
            ...
            "on_chain_tx_hash": {"dataType":"string","required":true},
    ...
    "KycResponse": {
        ...
        "properties": {
            ...
            "kyc_status": {"dataType":"string","required":true},
            "kyc_link": {"dataType":"string","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "DecodeQrRequest": {
        "dataType": "refObject",
        "properties": {
            "qr_data": {"dataType":"string","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/transaction-status/:transactionReference',
            authenticateMiddleware([{"ApiKeyAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(TransactionStatusController)),
            ...(fetchMiddlewares<RequestHandler>(TransactionStatusController.prototype.getTransactionStatus)),

            async function TransactionStatusController_getTransactionStatus(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    transactionReference: {"in":"path","name":"transactionReference","required":true,"dataType":"string"},
            };
        ...
        app.post('/kyc',
            ...
            ...(fetchMiddlewares<RequestHandler>(KycController.prototype.checkKyc)),

            async function KycController_checkKyc(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"KycRequest"},
            };
        ...
        app.post('/decode-qr',
            authenticateMiddleware([{"ApiKeyAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(DecodeQrController)),
            ...(fetchMiddlewares<RequestHandler>(DecodeQrController.prototype.decodeQr)),

            async function DecodeQrController_decodeQr(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"DecodeQrRequest"},
            };
            ...
            try {
                ...
                const controller = new DecodeQrController();
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/accept-transaction',
            authenticateMiddleware([{"ApiKeyAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(AcceptTransactionController)),
            ...(fetchMiddlewares<RequestHandler>(AcceptTransactionController.prototype.acceptTransaction)),

            async function AcceptTransactionController_acceptTransaction(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            ...
            try {
                ...
                const controller = new AcceptTransactionController();
