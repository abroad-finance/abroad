/*
  ...
  - A unique constraint covering the columns `[refundOnChainId]` on the table `Transaction` will be added. If there are existing duplicate values, this will fail.

*/
-- AlterTable
ALTER TABLE "public"."Transaction" ADD COLUMN     "refundOnChainId" TEXT;

-- CreateIndex
CREATE UNIQUE INDEX "Transaction_refundOnChainId_key" ON "public"."Transaction"("refundOnChainId");

-- Update view to expose the new refundOnChainId column
