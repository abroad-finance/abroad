...
let WalletAuthController: typeof import('../../../../../modules/auth/interfaces/http/WalletAuthController').WalletAuthController
...
describe('WalletAuthController', () => {
  ...
  beforeEach(async () => {
    ...
    const controllerModule = await import('../../../../../modules/auth/interfaces/http/WalletAuthController')
