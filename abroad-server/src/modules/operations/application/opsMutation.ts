...
export const OPS_MUTATION_POLICIES = {
  ...
  'treasury.stablebond.acquire': {
    approvalClass: 'STEP_UP',
    confirmation: 'ACQUIRE STABLEBOND POSITION',
    expectedVersion: false,
    impact: 'Spends treasury USDC on Stablebond tokens on a public venue, bounded by the configured slippage tolerance. This moves real treasury funds.',
    permission: 'treasury:manage',
    stepUpMaxAgeMs: DEFAULT_STEP_UP_MAX_AGE_MS,
  },
  'treasury.stablebond.open_trustline': {
    approvalClass: 'STEP_UP',
    confirmation: 'OPEN STABLEBOND TRUSTLINE',
    expectedVersion: false,
    impact: 'Opens a Stellar trustline for the Stablebond on the treasury account. Moves no funds; commits a base reserve.',
    permission: 'treasury:manage',
    stepUpMaxAgeMs: DEFAULT_STEP_UP_MAX_AGE_MS,
  },
  'treasury.stablebond.register_basis': {
    approvalClass: 'STEP_UP',
    confirmation: 'REGISTER STABLEBOND BASIS',
    expectedVersion: false,
    impact: 'Re-bases the Stablebond position at the currently held quantity and the live NAV. Moves no funds, but resets what counts as accrued yield.',
    permission: 'treasury:manage',
    stepUpMaxAgeMs: DEFAULT_STEP_UP_MAX_AGE_MS,
  },
  'treasury.stablebond.unwind': {
    approvalClass: 'STEP_UP',
    confirmation: 'UNWIND STABLEBOND POSITION',
    expectedVersion: false,
    impact: 'Sells Stablebond tokens on a public venue for USDC, bounded by the configured slippage tolerance. This moves real treasury funds.',
    permission: 'treasury:manage',
    stepUpMaxAgeMs: DEFAULT_STEP_UP_MAX_AGE_MS,
  },
