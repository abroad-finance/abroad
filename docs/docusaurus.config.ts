...
const config: Config = {
  ...
  organizationName: 'abroad-finance', // Usually your GitHub org/user name.
  projectName: 'abroad', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Abroad Finance. Built with Docusaurus.`,
    },
    prism: {
