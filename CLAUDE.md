...
|---|---|---|
| `--ab-green` / `--color-ab-green` | `text-ab-green`, `bg-ab-green` | Brand green (#0FBE7B) |
...
- Replace any raw Tailwind hex values (e.g. `bg-[#0FBE7B]`) with the corresponding `ab-*` token (`bg-ab-green`).
